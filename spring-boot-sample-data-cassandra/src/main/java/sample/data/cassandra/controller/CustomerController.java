...
//
//
// @Api(basePath = "/api/customer", produces = "application/json", value =
// "Customer", description = "Operations with customer")
// @RestController
...
// @ApiResponses(value = { @ApiResponse(code = 404, message = "Please check
// url"), @ApiResponse(code = 200, message = "List<Customers>"),
// @ApiResponse(code = 500, message = "Error occurred while fetching Customers")
// })
// @ResponseBody
// @RequestMapping(value = "/allCustomers", method = RequestMethod.GET, produces
// = "application/json")
// public ResponseEntity<List<CustomerModel>> getCustomers() {
// return new
// ResponseEntity<List<CustomerModel>>(this.customerService.findAll(),
// HttpStatus.OK);
// }
//
//
