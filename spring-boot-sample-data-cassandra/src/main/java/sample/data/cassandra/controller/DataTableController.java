...
// public ResponseEntity<ProductDataTableModel> getAllProducts(Model model,
// Pageable pageable) {
...
// public ResponseEntity<CustomerDataTableModel>
// deleteCustomer(@RequestParam("id") String id) {
//
// if (customerService.deleteCustomer(id)) {
// return new ResponseEntity<CustomerDataTableModel>(new
// CustomerDataTableModel(), HttpStatus.OK);
// }
//
// else {
// return null;
