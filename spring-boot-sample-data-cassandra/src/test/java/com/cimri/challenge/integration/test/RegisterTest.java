...
// assertEquals(registerUtil.getTestCount().intValue(),
// registerUtil.getRegisters().size());
// }
//
// @Test
...
//
// BinNumber binNumber =
// iyzicoService.binNumberQuery(register.getCardNumber().substring(0, 6));
//
...
// } else if (StringUtils.equalsIgnoreCase(binNumber.getCardType(),
// "DEBIT_CARD")) {
...
//
// Optional<TicketPrice> price =
// ticketPriceService.findByStartDateLessThanEqualAndEndDateGreaterThanEqual(
// register.getTransacitonDate(), register.getTransacitonDate());
//
// if (price.isPresent()) {
// // if discount code exist, find discount rate
// Optional<TicketDiscount> discount =
// ticketDiscountService.findByDiscountCode(register.getDiscountCode());
//
// if (discount.isPresent()) {
// BigDecimal finalPrice =
// priceUtil.processDiscountCodeAndReturnPrice(price.get(), discount.get());
