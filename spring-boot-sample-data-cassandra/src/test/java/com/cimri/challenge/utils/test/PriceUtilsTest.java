// package com.cimri.challenge.utils.test;
//
...
// this.priceUtils.processDiscountCodeAndReturnPrice(ticketPrice,
// ticketDiscount);
// assertEquals(BigDecimal.valueOf(225.0).doubleValue(),
// finalPrice.doubleValue(), DELTA);
// }
//
// }
